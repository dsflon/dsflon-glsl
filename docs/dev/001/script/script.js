...
(() => {
    ...
    function init(texture){
        ...
        let texCoord = [];
        {
            let width = window.parent.screen.width > 768 ? 3.0 : 2.0; // 全体の幅
            let half = width / 2.0;       // 幅の半分（上下左右に線対称に展開するため）
            let interval = window.parent.screen.width > 768 ? 0.015 : 0.01;           // 頂点同士の間隔
        ...
        function render(){
            ...
            // mat.rotate(mMatrix, nowTime * 0.2, [1.0, 0.0, 0.0], mMatrix);
