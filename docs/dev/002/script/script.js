...
(() => {
    ...
    function init(texture){
        ...
        let texCoord = [];
        {
            let width = window.parent.screen.width > 768 ? 6.0 : 4.0; // 全体の幅
            let half = width / 2.0;       // 幅の半分（上下左右に線対称に展開するため）
            let interval = window.parent.screen.width > 768 ? 0.5 : 0.3;           // 頂点同士の間隔
