...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        // ************************************************
        // ************************************************
        createTexture('./image/02.jpg', (texture) => {
    ...
    function init(texture){
        ...
        postPrg.uniLocation[3] = gl.getUniformLocation(postPrg.program, 'textureUnit');
        postPrg.uniType[3]     = 'uniform1i';
        ...
        function render(){
            ...
            // カメラ関連のパラメータ
            let cameraPosition    = [0.0, 0.0, 1.7];
            ...
            gl[postPrg.uniType[3]](postPrg.uniLocation[3], 1);
            // 描画
