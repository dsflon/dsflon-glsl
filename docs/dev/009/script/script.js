...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        //     if( -80 < event.beta && event.beta < 80 )  {
    ...
    function init(texture){
        ...
        //range
        scenePrg.uniLocation[7] = gl.getUniformLocation(scenePrg.program, 'range');
        scenePrg.uniType[7]     = 'uniform1f';
        //range
        scenePrg.uniLocation[8] = gl.getUniformLocation(scenePrg.program, 'mono');
        scenePrg.uniType[8]     = 'uniform1i';
        ...
        function render(){
            ...
            gl[scenePrg.uniType[7]](scenePrg.uniLocation[7], range);
            gl[scenePrg.uniType[8]](scenePrg.uniLocation[8], mono);
